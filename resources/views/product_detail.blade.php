    ...
    <div class=" main-body">
        <section class="flex-container-main justify-content-center max_width">
            ...
            <div class="flex-item-main-2">
                ...
                <img src="img/modem.png" width="657" height="544" id="product_1" class="main_product detail">
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 image__modem">
                            <img src="img/modem-z.svg" class="img-fluid ">
                        </div>
            ...
            <div class="container text-center">
                <div class="row justify-content-center mb-5">
                    <div class="col-md-4 col-sm-12">
                        <img src="img/global-support.svg">
            ...
            <div class="text-center">
                ...
                <div class="row">
                    <div class="col-lg-3 mb-5">
                        <img src="img/modem.png" class="mb-5" height="200px">
                        <h3 class="related__product__title mb-2">ZonModem</h3>
                        <p class="related__product__details mb-3">Worldide Anten</p>
                    </div>
                    <div class="col-lg-3 mb-5" >
                        <img src="img/router.png" class="mb-5"  height="200px">
                        <h3 class="related__product__title mb-2">ZonModem</h3>
                        <p class="related__product__details mb-3">Worldide Anten</p>
                    </div>
                    <div class="col-lg-3 mb-5">
                        <img src="img/sim.png" class="mb-5"  height="200px">
                        <h3 class="related__product__title mb-2">ZonModem</h3>
                        <p class="related__product__details mb-3">Worldide Anten</p>
                    </div>
                    <div class="col-lg-3 mb-5">

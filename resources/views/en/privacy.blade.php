    ...
    <div class="main-body fifth-color bg__contact pb-5">
        ...
        <section>
            <div class="container text-center  sixth-color">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-8 mb-5 mt-5 text-left" style="color: white">
                        <h1 >Privacy Policy</h1>
                        <p class="contact__text">
                            Zontelecom ("us", "we", or "our") operates the zontelecom.ca website (the "Service").<br>
                            This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy for Zontelecom is managed through Free Privacy Policy.<br>
                            We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from zontelecom.ca
                        </p>
                        <h3>Information Collection And Use</h3>
                        <p class="contact__text">We collect several different types of information for various purposes to provide and improve our Service to you.</p>
                        ...
                        <h3>Use of Data</h3>
                        <p>Zontelecom uses the collected data for various purposes:</p>
                        <ul>
                        ...
                        <p>Zontelecom may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                        <ul>
                            <li>To comply with a legal obligation</li>
                            <li>To protect and defend the rights or property of Zontelecom</li>
                        ...
                        <ul>
                            <li>By email: support@zontelecom.ca</li>
                        </ul>
                        {{--<div class="mb-5 mt-5">--}}
